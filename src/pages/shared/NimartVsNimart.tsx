...
const vsPageSchema = {
  ...
  "@type": "WebPage",
  "name": "Nimart vs. NIMART: What's the Difference?",
  "description": "Learn the difference between Nimart (Nigerian service marketplace) and NIMART (healthcare training). Find the right platform for your needs.",
...
export default function NimartVsNimart() {
  return (
    <>
      <SEO
        title="Nimart vs. NIMART – What's the Difference? | Nimart"
        description="Confused between Nimart (Nigeria's service marketplace) and NIMART (healthcare training)? This page explains the difference and helps you find what you need."
        keywords="Nimart vs NIMART, difference between Nimart and NIMART, Nigerian service marketplace, NIMART healthcare, Nimart disambiguation"
        url="https://nimart.ng/nimart-vs-nimart"
        schema={vsPageSchema}
        breadcrumbs={[
          { label: 'Home', to: '/' },
          { label: 'Nimart vs. NIMART' }
        ]}
      />
